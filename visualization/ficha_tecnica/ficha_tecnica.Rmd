...
donde $e = e(m)$ es el estado al que pertenece el municipio $m$ y la luminosidad $\Lambda^U$ es la correspondiente a la luminosidad urbana no petrolera --con $\ell \leq 175$-- que se introdujo anteriormente. 
...
```{r, results='asis'}
pred_metro <- read_csv("../../data/resultados/metro_acteco_35_muns.csv") %>%
  select(
    Periodo=trimestre, 
